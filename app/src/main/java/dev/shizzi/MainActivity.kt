                ...
                Surface(color = colors.background) {
                    ...
                    ShizziApp(
                        ...
                        actions = AppActions(
                            ...
                            onSetPortalCustomization = viewModel::setPortalCustomization,
                            onGenerateVouchers = viewModel::generateVouchers,
                            onDeleteVoucherTemplate = viewModel::deleteVoucherTemplate,
                            onSetAccessPassEnabled = viewModel::setAccessPassEnabled,
                            onAssignAccessPass = viewModel::assignAccessPass,
                            onRevokeAccessPass = viewModel::revokeAccessPass,
                            onCreatePrepaidAccount = viewModel::createPrepaidAccount,
                            onSetPrepaidAccountEnabled = viewModel::setPrepaidAccountEnabled,
                            onResetPrepaidAccountPin = viewModel::resetPrepaidAccountPin,
